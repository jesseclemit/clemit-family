...
function heroGreetUpd(){var g=document.getElementById('heroGreet');if(g)g.innerHTML='Hi, <b>'+esc(monikerName())+'</b>! What&#39;s on the agenda? <button class="note-cta" onclick="noteQuickOpen()" title="Got a note now?" aria-label="Got a note now?">&#128172;</button>';}
