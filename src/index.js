...
:root{--bg:#0c0408;--panel:#190a12;--panel2:#23101a;--line:#3d1622;--txt:#f1e9ec;--dim:#a98793;--acc:#ff3b54;--acc-bright:#ff8a9b;--acc-glow:rgba(255,59,84,.55);--acc2:#34e6ff;--warn:#ffb74d;--due:#ef5350;--bad:#ff5d6c;--cw:min(2200px,100%);}
...
#wrap{max-width:var(--cw);margin:0 auto;overflow-x:clip;}
...
#mqvWrap{position:fixed;z-index:5000;top:88px;right:14px;width:232px;background:rgba(12,4,8,.97);border:1px solid #ff3df0;border-radius:13px;box-shadow:0 12px 34px rgba(0,0,0,.6),0 0 16px rgba(255,61,240,.3);overflow:hidden;font-size:13px}#mqvWrap.mqvHide{display:none}#mqvHead{display:flex;align-items:center;gap:6px;padding:8px 10px;background:#23101a;border-bottom:1px solid #3d1622;cursor:grab;user-select:none}#mqvHead.mqvGrab{cursor:grabbing}#mqvHead b{font-size:12px;color:#ff8fe9}#mqvHead .mqvCnt{color:#a98793;font-size:10px}#mqvHead .mqvX{margin-left:auto;color:#cdb3bc;cursor:pointer;font-size:15px;line-height:1}#mqvList{max-height:42vh;overflow:auto}#mqvList .empty{padding:12px 10px;color:#7f6470;font-size:11px;text-align:center}.mqvRow{display:flex;align-items:center;gap:7px;padding:7px 9px;border-bottom:1px solid #1f0c16}.mqvRow .n{width:16px;text-align:center;color:#7f6470;font-size:11px}.mqvRow .t{flex:1;font-size:12px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.mqvRow .a{color:#7fa6b8;cursor:pointer;font-size:14px;padding:0 1px}.mqvRow .rm{color:#ff5d6c;cursor:pointer;font-size:14px}#mqvNote{padding:6px 9px;border-top:1px solid #2a0f1a;color:#7f6470;font-size:10px;display:flex;align-items:center;gap:5px}#mqvLauncher{position:fixed;right:16px;bottom:84px;z-index:5000;background:#23101a;border:1px solid #ff3df0;color:#ff8fe9;border-radius:999px;padding:8px 13px;font-size:12px;cursor:pointer;display:none;align-items:center;gap:6px;box-shadow:0 6px 18px rgba(0,0,0,.5)}#mqvLauncher.show{display:inline-flex}.libfbar{margin:8px 0 12px}.lfb-top{display:flex;gap:6px;flex-wrap:wrap}.lfb-sub{display:flex;gap:5px;flex-wrap:wrap;margin-top:6px}.lfb-chip{font-size:12px;padding:5px 12px;border-radius:8px;border:1px solid var(--line);background:var(--panel);color:var(--dim);cursor:pointer}.lfb-chip.on{background:#ff2d55;border-color:#ff2d55;color:#fff;font-weight:500}.lfb-schip{font-size:11px;padding:3px 10px;border-radius:999px;border:1px solid #2f3a4a;background:#11161f;color:#9fc6d8;cursor:pointer}.lfb-schip.on{background:#00e5ff;border-color:#00e5ff;color:#04303a;font-weight:500}@media(max-width:560px){.libtiles{display:none!important}}.hdr2{display:flex;flex-direction:column;align-items:stretch;gap:5px;padding:14px 22px 8px;}.hdr2 .hdrow{display:flex;align-items:baseline;gap:18px;}.hdr2 .hdrow1{justify-content:space-between;}.hdr2 .hero-greet{font-size:1.35rem;font-weight:700;line-height:1.25;min-width:0;}.hdr2 .hero-greet b{color:var(--acc);}.hdr2 .hdR{margin-left:auto;display:flex;align-items:center;gap:11px;flex:none;white-space:nowrap;color:var(--dim);font-size:.82rem;}.hdr2 .hdR a{color:var(--dim);text-decoration:none;border:1px solid var(--line);padding:5px 11px;border-radius:8px;}.hdr2 .hdR a:hover{color:var(--acc);border-color:var(--acc);}.hdr2 .hdR h1{font-size:1.3rem;margin:0;}.hdr2 .hdR h1 span{color:var(--acc);}.hdr2 .hdrow2{justify-content:space-between;align-items:baseline;}.hdQline{flex:1 1 0;min-width:0;max-width:100%;overflow:hidden;white-space:nowrap;}.hdQwrap{display:inline-block;white-space:nowrap;will-change:transform;}.hdr2 .hero-q{font-size:1rem;}.hdr2 .hero-a{color:var(--dim);font-size:.82rem;}.hdr2 .hero-sub{flex:none;color:var(--acc2);font-size:.9rem;font-style:italic;padding-left:16px;border-left:1px solid var(--line);}.note-cta{display:inline-flex;align-items:center;justify-content:center;width:30px;height:30px;padding:0;border-radius:50%;font-size:.95rem;gap:0;margin-left:10px;vertical-align:middle;}.note-cta .nc-h{display:none;}#monTip{position:fixed;z-index:400;max-width:248px;background:#1a0810;border:1px solid #ff2d55;color:#ffd0da;font-size:12px;line-height:1.4;padding:8px 26px 8px 10px;border-radius:8px;box-shadow:0 6px 20px rgba(0,0,0,.5);}#monTip .x{position:absolute;top:5px;right:8px;cursor:pointer;color:#ff7d92;font-size:14px;}@media(max-width:560px){.hdr2{padding:7px 9px;gap:2px;overflow:hidden;}.hdr2 .hdrow1{flex-wrap:nowrap;gap:6px;align-items:center;}.hdr2 .hdrow2{display:none;}.hdr2 .hero-greet{font-size:calc(15px*var(--hf,1));white-space:nowrap;line-height:1.25;min-width:0;}.hdr2 .hdR{white-space:nowrap;flex-wrap:nowrap;gap:5px;font-size:calc(12px*var(--hf,1));}.hdr2 .hdR h1{font-size:calc(14px*var(--hf,1));}.note-cta{width:calc(20px*var(--hf,1));height:calc(20px*var(--hf,1));font-size:calc(12px*var(--hf,1));margin-left:5px;}}</style></head><body><div id="bootveil"></div><div id="wrap">
<header class="hdr2"><div class="hdrow hdrow1"><div class="hero-greet" id="heroGreet">Good evening, <b>Boss</b>.</div><div class="hdR"><span class="role" id="role">...</span><span id="crownBadge" style="cursor:help;font-size:1.02rem"></span><label title="Choose your PULSE color" class="hdColor" style="display:inline-flex;align-items:center;cursor:pointer"><span style="width:20px;height:20px;border-radius:6px;border:2px solid var(--acc);box-shadow:0 0 8px var(--acc-glow);background:var(--acc);position:relative;overflow:hidden;display:inline-block"><input id="themeSw" type="color" value="#ff3b54" oninput="themeSet(this.value,true)" style="position:absolute;top:-6px;left:-6px;width:40px;height:40px;border:none;opacity:0;cursor:pointer"></span></label><span id="clock"></span><a href="/cdn-cgi/access/logout">Sign Out</a><h1>Clemit <span>Pulse</span></h1></div></div><div class="hdrow hdrow2"><div class="hdQline" id="heroQline"><span class="hdQwrap" id="heroQwrap"><span class="hero-q" id="heroQ">&hellip;</span> <span class="hero-a" id="heroA"></span></span></div><div class="hero-sub" id="heroSub"></div></div><span id="heroFav" style="display:none"></span></header>
...
let S={},cur='dj',djReady=false;try{Object.defineProperty(window,'S',{configurable:true,get:function(){return S;},set:function(v){S=v;}});}catch(e){}
...
function heroGreetUpd(){var g=document.getElementById('heroGreet');if(g)g.innerHTML='Hi, <b class="monClick" onclick="monReroll()" title="Click for a new title" style="cursor:pointer;text-decoration:underline dotted 1px;text-underline-offset:3px">'+esc(monStableName())+'</b>! What&#39;s on the agenda? <button class="note-cta" onclick="noteQuickOpen()" title="Got a note now?" aria-label="Got a note now?">&#128172;</button>';if(typeof monFitHeader==="function")monFitHeader();}
...
function heroTimers(){clearInterval(heroQT);clearInterval(heroTT);}
window.HS=(function(){
...
window.__pq=(function(){var wrap,box,t0,timer;function el(){box=document.getElementById("heroQline");wrap=document.getElementById("heroQwrap");return !!(wrap&&box);}function kick(){if(!el())return;clearTimeout(timer);t0=Date.now();wrap.style.transition="none";wrap.style.transform="translateX("+box.offsetWidth+"px)";var dur=Math.max(8,(box.offsetWidth+wrap.offsetWidth)/70);requestAnimationFrame(function(){wrap.style.transition="transform "+dur+"s linear";wrap.style.transform="translateX(-"+wrap.offsetWidth+"px)";});}function done(){var wait=Math.max(0,60000-(Date.now()-t0));timer=setTimeout(function(){if(typeof heroNextQuote==="function")heroNextQuote();},wait);}document.addEventListener("transitionend",function(e){if(e.target&&e.target.id==="heroQwrap"&&e.propertyName==="transform")done();},true);window.addEventListener("resize",function(){kick();});return {kick:kick,start:kick};})();function monLenTip(inp){var n=(inp&&inp.value||"").length;var t=document.getElementById("monTip");if(n>18){if(!t){t=document.createElement("div");t.id="monTip";var x=document.createElement("span");x.className="x";x.textContent="×";x.onclick=function(){var e=document.getElementById("monTip");if(e)e.remove();};var msg=document.createElement("span");msg.textContent="Heads up — titles over 18 characters look fine in the browser, but get cut off for mobile users. Trim it under 19 to be safe.";t.appendChild(x);t.appendChild(msg);document.body.appendChild(t);}var r=inp.getBoundingClientRect();t.style.left=Math.max(8,r.left)+"px";t.style.top=(r.bottom+6)+"px";}else if(t){t.remove();}}function monPickFrom(a){return a[Math.floor(Math.random()*a.length)];}function monStableName(){var c=ucfg();if(c&&c.moniker)return c.moniker;if(c&&c.monRotateDaily)return monDailyTitle();var arr=(c&&c.monikers&&c.monikers.length)?c.monikers:null;if(!arr)return monikerName();if(arr.length===1)return arr[0];var isOwner=!!(window.S&&S.me&&S.me.isOwner);if(isOwner){if(!window.__visitTitle)window.__visitTitle=monPickFrom(arr);return window.__visitTitle;}var today=new Date().toISOString().slice(0,10);var saved=null;try{saved=JSON.parse(localStorage.getItem("monDayTitle")||"null");}catch(e){}if(saved&&saved.d===today&&saved.t)return saved.t;var pick=monPickFrom(arr);try{localStorage.setItem("monDayTitle",JSON.stringify({d:today,t:pick}));}catch(e){}return pick;}function monReroll(){var c=ucfg();var arr=(c&&c.monikers&&c.monikers.length)?c.monikers:null;if(!arr||arr.length<2){if(typeof monAsk==="function")monAsk();return;}var cur=monStableName();var pick=cur;for(var i=0;i<10&&pick===cur;i++)pick=monPickFrom(arr);window.__visitTitle=pick;try{localStorage.setItem("monDayTitle",JSON.stringify({d:new Date().toISOString().slice(0,10),t:pick}));}catch(e){}if(typeof heroGreetUpd==="function")heroGreetUpd();}function monFitHeader(){if(window.innerWidth>560)return;var hdr=document.querySelector("header.hdr2"),row=document.querySelector(".hdr2 .hdrow1");if(!hdr||!row)return;hdr.style.setProperty("--hf","1");var avail=hdr.clientWidth-4;var fs=1,guard=0;while(row.scrollWidth>avail&&fs>0.38&&guard<40){fs-=0.04;hdr.style.setProperty("--hf",fs.toFixed(2));guard++;}}window.addEventListener("resize",function(){if(typeof monFitHeader==="function")monFitHeader();});
...
function __monikerSection(){var c=ucfg();var arr=c.monikers||[];var chips=arr.length?arr.map(function(n,i){return '<span class="mqchip">'+esc(n)+' <span class="x" onclick="monRemoveAt('+i+')">×</span></span>';}).join(''):'<span class="sub">None yet — PULSE will use your first name.</span>';var sugg=['Sir','Boss','Amigo','GodKing Emperor','AlphaGrandpa','Your Majesty','Captain','El Jefe','Chief','Maestro','Legend','Champ','Skipper','Commander','Sensei','Big Cheese','Sovereign','Trailblazer','Maverick','Sweetness','Sunshine','Wizard','Queen Bee','Admiral'];var suggHtml=sugg.map(function(n){return '<span class="qbtn" style="cursor:pointer" onclick="monAddName(\\''+n+'\\')">+ '+esc(n)+'</span>';}).join('');var h='<h2 style="font-size:.95rem;margin:14px 0 6px">How PULSE greets you</h2><div class="sub">PULSE rotates through your titles — it shows every one before reshuffling. Add as many as you like; leave it empty to just use your first name.</div>';h+='<div class="row" style="margin-top:8px;gap:6px;flex-wrap:wrap">'+chips+'</div>';h+='<div class="row" style="margin-top:10px;gap:8px;flex-wrap:wrap"><input id="monikerInput" oninput="monLenTip(this)" placeholder="Add your own title…" onkeydown="if(event.key===String.fromCharCode(69,110,116,101,114))monAddInput()"><button class="go" onclick="monAddInput()">Add</button></div>';h+='<div class="sub" style="margin-top:12px">Quick add — tap any:</div><div class="row" style="margin-top:6px;gap:6px;flex-wrap:wrap">'+suggHtml+'</div>';h+='<div class="row" style="margin-top:12px;gap:8px;flex-wrap:wrap"><button class="qbtn" onclick="changeMoniker()">Inspire me with a question</button><button class="qbtn'+(c.monRotateDaily?" on":"")+'" onclick="monDailyToggle()">Surprise me daily instead</button></div>';return h;}
...
function jpvFit(){
  ...
  box.style.width=((d.w+22)*k)+'px';box.style.height=Math.min((d.h+22)*k,window.innerHeight-150)+'px';
