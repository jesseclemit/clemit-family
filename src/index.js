...
if(sec==='books'){h+=booksReel('book');return h;}if(sec==='audiobooks'){h+=booksReel('audiobook');return h;}if(sec==='movies'){h+=moviesBody();return h;}
