...
function fvDim(mn){if(mn===null)return{op:0.16,gs:0.9,br:0.85,lab:'away'};if(mn<3)return{op:1,gs:0,br:1.18,lab:'now'};if(mn<15)return{op:1,gs:0.05,br:1.06,lab:mn+'m'};if(mn<30)return{op:0.8,gs:0.3,br:1,lab:mn+'m'};if(mn<45)return{op:0.6,gs:0.5,br:0.95,lab:mn+'m'};if(mn<60)return{op:0.44,gs:0.62,br:0.9,lab:mn+'m'};return{op:0.22,gs:0.8,br:0.82,lab:(mn<120?'1h+':Math.floor(mn/60)+'h')};}
