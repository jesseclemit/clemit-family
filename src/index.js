...
function heroGreetUpd(){var g=document.getElementById('heroGreet');if(g)g.innerHTML='Hi, <b class="monClick" onclick="monReroll()" title="Click for a new title" style="cursor:pointer;text-decoration:underline dotted 1px;text-underline-offset:3px">'+esc(monStableName())+'</b>! What&#39;s on the agenda? <button class="note-cta" onclick="noteQuickOpen()" title="Got a note now?" aria-label="Got a note now?">&#128172;</button>';}
